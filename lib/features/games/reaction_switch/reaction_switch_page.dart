...
class ReactionSwitchPage extends StatefulWidget {
  ...
  @override
  State<ReactionSwitchPage> createState() =>
      _ReactionSwitchPageState();
}

class _ReactionSwitchPageState
    extends State<ReactionSwitchPage> {
  ...
  void _next() {
    _question = ReactionSwitchQuestions.all[
        _random.nextInt(
