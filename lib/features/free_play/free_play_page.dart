...
class FreePlayPage extends StatefulWidget {
  ...
  @override
  State<FreePlayPage> createState() =>
      _FreePlayPageState();
}

class _FreePlayPageState
    extends State<FreePlayPage> {
  ...
  void initState() {
    ...
    AnalyticsService.freePlayOpened();
